    ...
    <div className="container mx-auto px-4 py-12 max-w-xl">
      ...
      {sent ? (
        ...
        <form onSubmit={handleSubmit} className="flex flex-col gap-6">
          ...
          <button
            type="submit"
            className="bg-primary hover:bg-primary-dark text-white font-medium py-3 px-6 rounded-xl transition-colors shadow-button focus:outline-none focus:ring-2 focus:ring-primary/50"
          >
            Envoyer
          </button>
        </form>
